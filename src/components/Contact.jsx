...
const Contact = () => {
  return (
    <div name='contact' className="w-full h-screen bg-gradient-to-b to-black via-black from-blue-600 p-4 text-white">
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/4caac2f1-f6a2-41b3-a1bb-3f5b71a3fe94" method="POST" className="flex flex-col w-full md:w-1/2">
                    ...
                    <textarea name="message=" rows="10" placeholder='Please Specify What You Want Done Whether Its An iOS Device Or Sony PlayStation, Also please include what games/emulators you would like.' className="p-2 bg-transparent border-2 rounded-md text-white cursor-pointer hover:scale-105 duration-300 focus:outline-none"></textarea>
